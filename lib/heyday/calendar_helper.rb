module Heyday
  module CalendarHelper
    ...
    # :today_css_class => "today" # Highlights today on the calendar using CSS class.
    ...
    # The variables you have to work with in this block are passed in an agruments hash:
